...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider msprovider = new Microsoft.AerialProvider();
		// Set a zoom level
		int zoomLevel = 20;
		...
		map2 = new UnfoldingMap(this,250,50,200,300,msprovider);
		map2.zoomAndPanTo(zoomLevel, new Location(37.9f, -122.3f));
