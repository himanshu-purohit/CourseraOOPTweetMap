...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// TODO: Add the method:
	// Compares Earthquakes by magnitude
	 ...
	 public boolean equals(EarthquakeMarker Marker)
	 {
		 if (this.getMagnitude() == Marker.getMagnitude()) return true;
		 return false;
	 }
	 public int hashCode()
	 {
		 int result = 17;
		 int c = Float.floatToIntBits(this.getMagnitude());
